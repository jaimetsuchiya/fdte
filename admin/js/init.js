...
function Variant() {
    function a() {
        $(".viu").html($("#veu").html()), vb = $("#veu"), wb = $(".viu"), xb = "undefined" !== $("body").attr("mrv_namespace") ? $("body").attr("mrv_namespace") : "mrv_variant.default", yb = $("body").attr("mrv_contentTarget") ? $("#veu " + $("body").attr("mrv_contentTarget")) : vb, zb = $("body").attr("mrv_contentTarget") ? $(".viu " + $("body").attr("mrv_contentTarget")) : wb, Ab = $("body").attr("mrv_navTarget") ? $("#veu " + $("body").attr("mrv_navTarget")) : yb, Bb = $("body").attr("mrv_navTarget") ? $(".viu " + $("body").attr("mrv_navTarget")) : zb, Cb = $("body").attr("mrv_footerTarget") ? $("#veu " + $("body").attr("mrv_footerTarget")) : yb, Db = $("body").attr("mrv_footerTarget") ? $(".viu " + $("body").attr("mrv_footerTarget")) : zb
    }
    ...
    function c(a) {
        var c, d, e = $("#" + a).find("section, header, footer").clone(),
            f = g($(e));
        Cb.selector != yb.selector ? $(e).addClass(a + "-" + f).appendTo(yb) : (c = $(yb).find("footer"), c.length ? $(e).addClass(a + "-" + f).insertBefore(c) : $(e).addClass(a + "-" + f).appendTo(yb)), $(".vem").append('<div class="vaa data-vfs="' + a + '" vbq="' + a + "-" + f + '"><div class="vab"><span class="vir" contenteditable="true">' + $("#" + a).attr("vbr") + '</span></div><i class="vca variant-icon variant-close-circle" vbq="' + a + "-" + f + '"></i></div>'), db(), $("#veu .youtube-bg-iframe").each(function (a) {
            var b = (new Date).getTime();
            $(this).attr("id", "yt-" + b + "-" + a).attr("src", $(this).attr("youtube-src")).removeAttr("youtube-src")
        }), V(), h(), b(), muteAllYouTube(), d = $(".vem"), layoutMapHeight = d[0].scrollHeight, d.animate({
    ...
    function d(a, b) {
        if ($("#veu nav, .viu nav").remove(), "vir" == b) {
            var c = $("#" + a).clone();
            $(c).find("script.options").remove(), Ab.prepend(c.html()), Ab.find("nav").addClass("vir").attr("nav-id", a), g(Ab.find("nav")), nb(a)
        }
        "vhz" == b && (c = tb($("#vbn [via=" + a + "]").get(0), !0), Ab.prepend(c), nb($("#vbn [via=" + a + "]").attr("nav-id"))), V(), h()
    }

    function e(a, b) {
        if ($("#veu footer").remove(), "vir" == b) {
            var c = $("#" + a).html();
            Cb.append(c), Cb.find("footer").addClass("vir"), g(Cb.find("footer"))
        }
        "vhz" == b && (c = tb($("#vbl [vhy=" + a + "]").get(0), !0), Cb.append(c)), V(), h()
    }
    ...
    function g(a) {
        var b = (new Date).getTime(),
            c = "vjs-" + b;
        return $(a).is("section, nav, header, .divider-background") && ($(a).attr("vic", c), $(a).addClass(c)), $(a).find("p, span, a, h1, h2, h3, h4, h5, h6, strong, em, ul, li, div, i, img, section, header, figure, video, iframe, input, textarea, blockquote, figcaption").each(function (a) {
            var b = c + "-" + a;
            $(this).attr("vic", b), $(this).addClass(b), $(this).is("nav, nav li, .slides > li, ul, div, i, img, section, header, figure, video, iframe, input, textarea, .vjx") || ($(this).addClass("vir"), $(this).attr("contenteditable", "true"))
        }), b
    }
    ...
    function l() {
        var a, b = (new Date).getTime(),
            c = "via-" + b,
            d = $(".vgb").val();
        $(".vfj").closest(".vho").find(".vly").text(d), $(".vgb").val(""), $("#veu nav").removeClass("vir").addClass("vhz").addClass(c).attr("via", c).attr("vio", d), $(".viu nav").removeClass("vir").addClass("vhz").addClass(c).attr("via", c).attr("vio", d), $("#vbn").append($("#veu nav").clone()), a = $("#vbn").html(), $.localStorage(xb + ".vbo", a), m($("." + c))
    }
    ...
    function n() {
        $("#vbn").append($.localStorage(xb + ".vbo")), $("#vbn nav").each(function () {
            m($(this))
        })
    }
    ...
    function o() {
        var a = $(".viu nav"),
            b = a.attr("via");
        $("#veu ." + b).html(a.html()).attr("class", a.attr("class")), $("#vbn ." + b).html(a.html()).attr("class", a.attr("class")), $("#vbn .vjb").removeClass("vjb"), $.localStorage(xb + ".vbo", $("#vbn").html())
    }

    function p() {
        var a = $(".viu footer"),
            b = a.attr("vhy");
        $("#veu ." + b).html(a.html()), $("#vbl ." + b).html(a.html()), $("#vbl .vjb").removeClass("vjb"), $.localStorage(xb + ".vbm", $("#vbl").html())
    }
    ...
    function r() {
        var a, b = (new Date).getTime(),
            c = "vhy-" + b,
            d = $(".vfz").val();
        $(".vdm").closest(".vho").find(".vly").text(d), $(".vfz").val(""), $("#veu footer").removeClass("vir").addClass("vhz").addClass(c).attr("vhy", c).attr("vie", d), $(".viu footer").removeClass("vir").addClass("vhz").addClass(c).attr("vhy", c).attr("vie", d), $("#vbl").append($("#veu footer").clone()), a = $("#vbl").html(), $.localStorage(xb + ".vbm", a), s($("." + c))
    }
    ...
    function t() {
        $("#vbl").append($.localStorage(xb + ".vbm")), $("#vbl footer").each(function () {
            s($(this))
        })
    }
    ...
    function B(a) {
        var b, c, d, e = a.data("vip");
        b = $(a).find(e.selector + "[" + e.attribute + "]").length ? $(a).find(e.selector + "[" + e.attribute + "]") : $(a), d = "undefined" != typeof e.modalInputIcon ? e.modalInputIcon : "pencil", c = b.attr(e.attribute), $(".vbk").text(e.modalTitle), $(".vbh").text(e.modalIntro), $(".vbf").text(e.modalInputLabel), $(".vkh").attr("data-glyph", d), $(".vbg").val(c), $(".vbe").val($(b).attr("vic")), $(".vbc").val(e.attribute), $(".vbk").text(e.modalTitle), $(a).is("section, header") ? $(".vgk").text(e.buttonText).attr("data-glyph", d).removeClass("vih") : $(".vdh").text(e.buttonText).attr("data-glyph", d).removeClass("vih")
    }
    ...
    function D() {
        var a = $("." + $(".vbe").val()),
            b = $(".vbg").val(),
            c = $(".vbc").val(),
            d = $(a).closest("[data-vip]").data("vip"); - 1 !== b.indexOf("<") && (!$(b).is("iframe") || "src" !== c && "no-src" !== c || (b = $(b).attr("src"), "//" === b.substring(0, 2) && (b = "https:" + b), -1 !== b.indexOf("youtube.com") && (b += "?showinfo=0&rel=0&modestbranding=1", a.hasClass("youtube-bg-iframe") && (b += "&enablejsapi=1&autoplay=1&controls=0&loop=1&iv_load_policy=3")), -1 !== b.indexOf("vimeo.com") && (b += "?badge=0&title=0&byline=0"))), $(a).is("iframe") && "no-src" == c ? ($(a).attr(c, b), $(".viu ." + $(".vbe").val()).attr("src", b)) : $(a).attr(c, b), V(), "true" === d.refresh && h()
    }
    ...
    function L() {
        var a = $("<div />").addClass("vmh"),
            ...
            c = $("<div />").addClass("vmh"),
            d = "";
        if ($.localStorage(xb + ".gallery.images")) $("#vdp").html($.localStorage(xb + ".gallery.images")), $("#vdp div").each(function () {
    ...
    function M() {
        $.localStorage(xb + ".gallery.images", $(".vdx").html()), $("#vdp").html($(".vdx").html())
    }
    ...
    function V() {
        var a = $.localStorage(xb + ".vhh");
        $(".vhe").addClass("vih"), o(), p(), $.localStorage(xb + ".vhh") ? ($.localStorage(xb + ".state.veu." + a, $("#veu").html()), $.localStorage(xb + ".state.vem." + a, $(".vem").html()), $.localStorage(xb + ".vhj." + a, $(".vei").text()), $.localStorage(xb + ".vhf." + a, $(".vay").attr("vhx")), $.localStorage(xb + "vmp." + a, $(".vms").attr("vmr")), $.localStorage(xb + ".vkp." + a, "undefined" != typeof $("#vkk").attr("class") ? $("#vkk").attr("class") : " ")) : ($.localStorage(xb + ".state.veu", $("#veu").html()), $.localStorage(xb + ".state.vem", $(".vem").html()), $.localStorage(xb + ".vhj", $(".vei").text()), $.localStorage(xb + ".vhf", $(".vay").attr("vhx")), $.localStorage(xb + "vmp", $(".vms").attr("vmr")), $.localStorage(xb + ".vkp", "undefined" != typeof $("#vkk").attr("class") ? $("#vkk").attr("class") : " "))
    }

    function W() {
        var a = (new Date).getTime();
        newStateName = $(".vgf").val(), stateID = "viy-" + a, $("#vhl").append('<li class="viy" viy="' + stateID + '" vjh="' + newStateName + '" page-title="' + $(".vei").text() + '"></li>'), X(newStateName, stateID), $('#vhl [viy="' + $.localStorage(xb + ".vhh") + '"]').attr("page-title", $(".vei").text()), $.localStorage(xb + ".vhk", $("#vhl").html()), $.localStorage(xb + ".state.veu." + stateID, $("#veu").html()), $.localStorage(xb + ".state.vem." + stateID, $(".vem").html()), $.localStorage(xb + ".vhj." + stateID, $(".vei").text()), $.localStorage(xb + ".vhf." + stateID, $(".vay").attr("vhx")), $.localStorage(xb + "vmp." + stateID, $(".vms").attr("vmr")), $.localStorage(xb + ".vkp." + stateID, $("#vkk").attr("class")), $.localStorage(xb + ".vhh", stateID), $.localStorage(xb + ".vhg", newStateName), $(".vcr").text(newStateName).removeClass("vih")
    }

    function X(a, b) {
        $(".vfw").prepend('<div class="ves" vjh="' + a + '" state-id="' + b + '"><span class="oi vdj" data-glyph="data-transfer-download"></span><span class="vfx">' + a + '</span><span class="vbz oi" data-glyph="x"></span></div>'), Fb && $(".vdj").remove()
    }
    ...
    function Y(b, c) {
        ...
        var d, b = "undefined" != typeof b ? b : "",
            ...
            e = $.localStorage(xb + ".vhj");
        b || (b = $.localStorage(xb + ".vhh"), c = $.localStorage(xb + ".vhg")), stateHTML = ".state.veu." + b, d = ".state.vem." + b, colourScheme = ".vhf." + b, fontOption = "vmp." + b, bodyClasses = ".vkp." + b, $('#vhl [viy="' + b + '"]').attr("page-title") ? e = $('#vhl [viy="' + b + '"]').attr("page-title") : ($(".vei").text("Edit title tag"), document.title = "Variant HTML Builder by Medium Rare"), $.localStorage(xb + ".vhh", b), $.localStorage(xb + ".vhg", c), b || (stateHTML = ".state.veu", d = ".state.vem", colourScheme = ".vhf", fontOption = "vmp", bodyClasses = ".vkp", e = $.localStorage(xb + ".vhj")), $.localStorage(xb + stateHTML) && (c = c ? c : "Unnamed page", $(".vcr").text(c).removeClass("vih"), $(".vei").text(e), document.title = e, $("#veu").html($.localStorage(xb + stateHTML)), $(".vem").html($.localStorage(xb + d)), pb($.localStorage(xb + bodyClasses)), ib($.localStorage(xb + colourScheme), !1), jb($.localStorage(xb + fontOption), !1), db(), a(), nb(), h()), $(".vem").find(".vaa").length ? $(".vem").removeClass("empty-vem") : $(".vem").addClass("empty-vem")
    }
    ...
    function Z(a) {
        ...
        return $("#vhl .viy").length ? ("all" == a ? ($("#vhl .viy").each(function () {
            ...
            c = $.localStorage(xb + ".state.veu." + a), d = $.localStorage(xb + ".state.vem." + a), colourScheme = $.localStorage(xb + ".vhf." + a), fontOption = $.localStorage(xb + "vmp." + a), bodyClasses = $.localStorage(xb + ".vkp." + a), pageName = $('#vhl [viy="' + a + '"]').attr("vjh"), pageTitle = $('#vhl [viy="' + a + '"]').attr("page-title"), pageTitle = "undefined" != typeof pageTitle ? pageTitle : "", e = {
                stateID: a,
                templateName: xb,
                pageName: pageName,
                pageTitle: pageTitle,
        ...
        }), h.file(xb + ".navs", $("#vbn").html()), h.file(xb + ".footers", $("#vbl").html()), "all" != a && (b = T(pageName)), g = h.generate({
            type: "blob",
            compression: "deflate"
    ...
    function _(a) {
        for (var b, c = a.target.files, d = 0; b = c[d]; d++) {
            var e = new FileReader;
            e.onload = function (a) {
                return function (b) {
                    try {
                        var c = new JSZip(b.target.result),
                            d = '<span class="vjl">Imported the following:</span>';
                        excludedHead = '<span class="vjl">Excluded these:</span>', fileNames = "<ul>", excluded = "<ul>", $.each(c.files, function (a, b) {
                            var c, d;
                            b.name == xb + ".navs" ? (c = b.asText().trim(), c = $('<div id="variant-temp-navs-mrv" />').html(c), $(c).find("nav").each(function () {
                                $('#vbn [via="' + $(this).attr("via") + '"]').length ? excluded += "<li>Nav - " + $(this).attr("vio") + " (already exists)</li>" : (m($(this)), $("#vbn").append($(this)), $.localStorage(xb + ".vbo", $("#vbn").html()), fileNames += "<li>Nav - " + $(this).attr("vio") + "</li>")
                            })) : b.name == xb + ".footers" ? (footers = b.asText().trim(), footers = $('<div id="vjj" />').html(footers), $(footers).find("footer").each(function () {
                                $('#vbl [vhy="' + $(this).attr("vhy") + '"]').length ? excluded += "<li>Footer - " + $(this).attr("vie") + " (already exists)</li>" : (s($(this)), $("#vbl").append($(this)), $.localStorage(xb + ".custom-footers", $("#vbl").html()), fileNames += "<li>Footer - " + $(this).attr("vie") + "</li>")
                            })) : (d = JSON.parse(b.asText()), d.templateName == xb ? $('#vhl [viy="' + d.stateID + '"]').length ? excluded += "<li>Page - " + d.pageName + " (already exists)</li>" : (fileNames += "<li>Page - " + d.pageName + "</li>", stateID = d.stateID, $("#vhl").append('<li class="viy" viy="' + d.stateID + '" vjh="' + d.pageName + '" page-title="' + d.pageTitle + '"></li>'), X(d.pageName, d.stateID), $.localStorage(xb + ".state.veu." + stateID, d.masterHtml), $.localStorage(xb + ".state.vem." + stateID, d.layoutMap), $.localStorage(xb + ".vhf." + stateID, d.colourScheme), $.localStorage(xb + "vmp." + stateID, d.fontOption), $.localStorage(xb + ".vkp." + stateID, d.bodyClasses)) : excluded += "<li>Page - " + d.pageName + " (not designed for this template)</li>")
                        }), $.localStorage(xb + ".vhk", $("#vhl").html()), fileNames += "</ul>", excluded += "</ul>", "<ul></ul>" != fileNames && (fileNames = d + fileNames), "<ul></ul>" != excluded && (excluded = excludedHead + excluded), A("Import", fileNames + "<br />" + excluded), setTimeout(function () {
                            $(".vfw").find(".ves").length ? $(".vfw").removeClass("empty-vfw") : $(".vfw").addClass("empty-vfw")
                        }, 50)
                    } catch (b) {
                        A("Page Import Error", "Error reading " + a.name + " : <br /><br />" + b.message)
                    }
                }
            }(b), e.readAsArrayBuffer(b)
        }
    }

    function ab() {
        $("#vhl").html($.localStorage(xb + ".vhk")), $("#vhl li").each(function () {
    ...
    function mb() {
        try {
            ...
            $.isArray(a.options) ? $(a.options).each(function () {
                ob(this, ".vkx", "body, #vkk", !0)
            }) : ob(a.options, ".vkx", "body, #vkk", !0)
        } catch (b) {
            return
        }
    }
    ...
    function nb(a) {
        ...
        try {
            ...
            $.isArray(b.options) ? $(b.options).each(function () {
                ob(this, ".vmm", Bb.selector + " nav, " + Ab.selector + " nav", !0)
            }) : ob(b.options, Bb.selector + " nav, " + Ab.selector + " nav", !0)
        } catch (c) {
            return
        }
    }
    ...
    function ob(a, b, c, d) {
        var e = "undefined" != typeof d ? d : !1,
            c = "undefined" != typeof c ? c : !1,
            f = "on" == a.initial ? "on" : "off",
            g = $("<li>"),
            h = $("<div>"),
            i = "";
        g.addClass("vmk"), a.title && g.append("<span>" + a.title + "</span>"), "choice" == a.type && ("on" == f && 1 == e && $(c).addClass(a["class"]), h.addClass("vky").attr("optionalclass", a["class"]).attr("classtarget", c), h.append('<div class="vks choice-button-on ' + ("on" == f && e === !0 ? "vkr" : "") + ($(c).hasClass(a["class"]) && e !== !0 ? "vkr" : "") + '">' + a.onText + "</div>"), h.append('<div class="vks choice-button-off ' + ("off" == f && e === !0 ? "vkr" : "") + ($(c).hasClass(a["class"]) || e === !0 ? "" : "vkr") + '">' + a.offText + "</div>"), g.append(h)), "toggle" == a.type && ("on" == f && 1 == e && $(classtarget).addClass(a["class"]), i = "on" == f && e === !0 ? " vku" : "", i = "auto" === a.initial && $(c).hasClass(a["class"]) ? " vku" : i, h.addClass("vkz").attr("optionalclass", a["class"]).attr("classtarget", c), h.append('<span class="oi" data-glyph="' + a.icon + '"></span><span>' + a.text + "</span>"), h.append('<div class="vkt' + i + '"><div class="vmi"></div></div>'), g.append(h)), "multi" == a.type && (h.addClass("vmj").attr("classtarget", c), $.each(a.classes, function (b, c) {
            h.append('<div class="vkv ' + (a.initial == b + 1 && e === !0 ? "vkw" : "") + '" optionalclass="' + ("" !== c["class"] ? c["class"] : " ") + '">' + c.text + "</div>")
        }), g.append(h)), $(b).append(g)
    }
    ...
    function sb() {
        $.localStorage(xb + ".vhh") ? ($(".vet span").html("Load " + $.localStorage(xb + ".vhg")), $(".vhe").removeClass("vih")) : $.localStorage(xb + ".state.veu") ? ($(".vet span").removeClass("vih"), $(".vhe").removeClass("vih")) : $(".vhd").removeClass("vih"), Fb && $(".vah, .vdi, .vgy").remove()
    }
    ...
    var ub, vb, wb, xb, yb, zb, Ab, Bb, Cb, Db, Eb = "",
        Fb = Object.prototype.toString.call(window.HTMLElement).indexOf("Constructor") > 0;
    a(), $(document).bind("mouseup", function (a) {
        1 === a.which && $(".vhw").hide()
    }), $(document).ready(function () {
        function a(a, b, c, d) {
            var e, f, g, h, j, k = a;
            return k.find("h1:empty, h2:empty, h3:empty, h4:empty, h5:empty, h6:empty, a:empty, p:empty, span:empty, li:empty, em:empty, strong:empty, blockquote:empty, figcaption:empty").not(".in-page-link").addClass("vib"), k.find(".vib, .vjb").each(function () {
                G($(this))
            }), k.find("div.row:not(:has(>div, >p, >h1, >h2, >h3, >h4, >h5, >h6, >span, >ul, >li, >strong, >em, >a, >i, >img, >figure, >video, >iframe, >form, >input, >textarea, >blockquote, >figcaption))").remove(), k.find(".vjd:not(:has(>div, >p, >h1, >h2, >h3, >h4, >h5, >h6, >span, >ul, >li, >strong, >em, >a, >i, >img, >figure, >video, >iframe, >form, >input, >textarea, >blockquote, >figcaption))").remove(), $(k).find("p, span, li, ul, h1, h2, h3, h4, h5, h6, nav, header, footer, strong, em, a, section, div, i, img, figure, video, iframe, input, textarea, blockquote, figcaption").removeClass("vjm vjb").removeClass("vhz").removeClass("vir").alterClass("vjs-*", "").alterClass("v-*", "").alterClass("variant-*", "").removeClass("vjd").removeClass("viv").removeClass("vlk").removeClass("ven").removeClass("vjy").removeAttr("vic").removeClass("vjx").removeAttr("vij").removeAttr("vik").removeAttr("contenteditable").removeAttr("data-vip").removeAttr("vli").removeAttr("vht").removeAttr("vjw").removeAttr("vii").removeAttr("style").removeAttr("nav-id"), $(k).find("nav").alterClass("via-*", "").removeAttr("via").removeAttr("vio").removeAttr("style"), $(k).find("footer").alterClass("vhy-*", "").removeAttr("vhy").removeAttr("vie"), $(k).find('*[class=""]').removeAttr("class"), e = $("#vji").html(), e = String(e).replace("[title]", b), $("[vhx]").length && (e = String(e).replace($("[viq]").attr("viq"), $("[vhx]").attr("vhx"))), j = qb(e, d), e = j ? j : e, e = rb(e, c), f = $(k).html().replace(/\n/g, "\n		").replace(/\n\n/g, "\n").replace(/\n\t\t><section/g, ">\n			<section").replace(/\n\t\t<header/g, "\n			<header").replace(/\t\t\t<\/header></g, "			</header>\n			<").replace(/\t\t\t<\/section></g, "			</section>\n			<").replace(/<\/a><section/g, "</a>\n			\n			<section").replace(/<\/a><header/g, "</a>\n			\n			<header").replace(/<\/section>\n\t\t\t<a/g, "</section>\n			\n			<a").replace(/<\/header>\n\t\t\t<a/g, "</header>\n			\n			<a").replace(/\t\t\t<\/section>\n\t\t\t<\/div>/g, "			</section>\n		</div>").replace(/\t\t\t<\/header>\n\t\t\t<\/div>/g, "			</header>\n		</div>").replace(/\t\t\t<\/header>\n\t\t\t<section/g, "			</header>\n			\n			<section").replace(/\t\t\t<\/section>\n\t\t\t<header/g, "			</section>\n			\n			<header").replace(/\t\t\t<\/section>\n\t\t\t<section/g, "			</section>\n			\n			<section").replace(/\t\t\t<\/header>\n\t\t\t<header/g, "			</header>\n			\n			<header"), f = i(f), g = $("#vif").html(), h = String(e + f + g), h = String(h).replace(/\.\.\/img\//g, "img/").replace(/\.\.\/video\//g, "video/").replace(/delay-src/g, "src").replace(/no-src/g, "src")
        }
        $(window).resize(b), b(), P(), L(), O(), ab(), n(), t(), eb(), fb(), mb(), -1 != navigator.userAgent.indexOf("NT 6.") && $("head").append("<style>::-webkit-scrollbar { width: 8px; background-color: rgba(0,0,0,0); -webkit-border-radius: 100px; } ::-webkit-scrollbar-thumb:vertical { background: rgba(0,0,0,0.3); -webkit-border-radius: 100px; } </style>"), ub = new Date, $(".vkg").text(ub.getFullYear()), $(".vla").flexslider({
            controlNav: !1,
            directionNav: !1,
            slideshowSpeed: 4e3,
            start: function () {
            ...
            alert('achei o start new page');
            $.localStorage(xb + ".vhh", ""), $.localStorage(xb + ".vhg", ""), $(".vhe").addClass("vih"), $(".vac").trigger("click"), $(".vkm").addClass("vjz")
        }), $(".vac").click(function () {
            ...
            document.title = $(this).text(), $.localStorage(xb + ".vhh") ? ($('#vhl [viy="' + $.localStorage(xb + ".vhh") + '"]').attr("page-title", $(this).text()), $.localStorage(xb + ".vhk", $("#vhl").html())) : $.localStorage(xb + ".vhj", $(this).text()), V()
        }), $(".vei.vlx").on("click focus blur keyup paste input", function () {
            $.localStorage(xb + ".vhh", ""), $.localStorage(xb + ".vhg", ""), $(".vhe").addClass("vih"), $(this).removeClass("vlx")
        ...
        try {
            ...
            $(".vml").removeClass("vih"), $(".vdq, .vah, .vgy").click(function () {
                A("Demo Only", 'Getting HTML in the demo is disabled.<br /><br />You may export your page in a .variant file and import it when you <a href="#purchase-template" target="_blank">purchase the full version</a>.')
            })
        }
        $(".vek").remove(), $(".vdq").click(function () {
            alert('seria este o save?');
            var c = $("#veu").clone(),
                d = document.title,
                e = $(".vms").attr("vmr"),
            ...
            }), "" != $.localStorage(xb + ".vbu") && $.localStorage(xb + ".vbu", $("#image-edit-chooser").attr("vbv"))
        }), $(".vgy").click(function () {
            var a, b = "",
                c = "";
            b = $.localStorage(xb + ".vhg"), b = "undefined" != typeof $.localStorage(xb + ".vhg") ? $.localStorage(xb + ".vhg") : "page", c = $(".vfu").val(), a = new Blob([c], {
            ...
            }), b = "variant-exported-" + T(f.toDateString()), e.forEach(function (b) {
                var c, e, g, h, i, j, k;
                f = new Date, j = $('#vhl [viy="' + b + '"]').attr("vjh"), k = $('#vhl [viy="' + b + '"]').attr("page-title"), g = "undefined" != typeof $.localStorage(xb + "vmp." + b) ? $.localStorage(xb + "vmp." + b) : "", h = "undefined" != typeof $.localStorage(xb + ".vkp." + b) ? $.localStorage(xb + ".vkp." + b) : "", c = $.localStorage(xb + ".state.veu." + b), e = $('<div id="vjk" />').html(c), i = $('<textarea id="variant-temp-textarea-mrv" />').append(a(e, k, g, h)), j = 1 == $('#vhl [vjh="' + j + '"]').length ? T(j) + ".html" : T(j) + "-" + f.getTime() + ".html", d.file(j, i.val())
            }), c = d.generate({
                type: "blob",
                compression: "deflate"
            }), void saveAs(c, "html-pages-" + T(f.toDateString()) + ".zip")) : void A("Export HTML", "There was nothing to export.<br /><br />Save at least one page before exporting.")
        }), $(".vap").click(function () {
            $('.vfj [vit="vhz"]').remove(), $("#vbn").html(""), $.localStorage(xb + ".vbo", ""), $(".vap").html("Cleared").removeClass("val").addClass("vak"), setTimeout(function () {
                $(".vap").html("Clear Navs").removeClass("vak").addClass("val")
            }, 1500)
        }), $(".vao").click(function () {
            $('.vdm [vit="vhz"]').remove(), $.localStorage(xb + ".vbm", ""), $(".vao").html("Cleared").removeClass("val").addClass("vak"), setTimeout(function () {
            ...
            $("#vhl li").each(function () {
                ...
                a = $.localStorage.io(xb + ".state.veu." + b), a.remove(), a = $.localStorage.io(xb + ".state.vem." + b), a.remove(), $(this).remove()
            }), $(".vfw div").remove(), $(".vfw").addClass("empty-vfw"), a = $.localStorage.io(xb + ".state.veu"), a.remove(), a = $.localStorage.io(xb + ".state.vem"), a.remove(), a = $.localStorage.io(xb + ".vhj"), a.remove(), a = $.localStorage.io(xb + ".vhh"), a.remove(), a = $.localStorage.io(xb + ".vhg"), a.remove(), a = $.localStorage.io(xb + ".vhk"), a.remove(), $(".vaq").html("Cleared").removeClass("val").addClass("vak"), setTimeout(function () {
        ...
        }), $(document).on("blur keyup paste input", "[contenteditable], strong", function () {
            ...
            k($(this))
        }), $(document).on("keyup paste input", ".vaa span", function () {
            S($(this))
            ...
            Eb.length && (219 === a.keyCode && R(Eb), 221 === a.keyCode && Q(Eb))
        }), $(document).on("click", "a.vjx", function (a) {
            return a.preventDefault ? a.preventDefault() : a.returnValue = !1, !1
        }), $(document).on("contextmenu", "[vic]", function (a) {
            if ($(".viu .vhw").remove(), a.shiftKey) return !0;
            ...
            return htmlTags = {
                ...
                BLOCKQUOTE: "Quote",
                FIGCAPTION: "Caption"
            }, $(".vau").text(htmlTags[m.get(0).tagName]).removeClass("vih"), $(m).data("variant-optional-classes-mrv") && $(".vki").removeClass("vih"), $(m).data("vip") ? B(m) : $(m).closest("[data-vip]").length && B($(m).closest("[data-vip]")), m.is("p , span, h1, h2, h3, h4, h5, h6, strong, em, li, ul, div, blockquote, figcaption") && ($(".var").unbind("click").bind("click", function () {
                E(m.attr("vic"))
                ...
                w(c)
            }))), m.closest("header").find(".background-image").length && (c = $(m).closest("header").find(".background-image"), c.hasClass("background-image") && ($(".vcg").removeClass("vih"), c = $(c).attr("vic"), $(".vcg").unbind("click").bind("click", function () {
                w(c)
                ...
                w(imageAttr)
            }))), m.is("div.background-image-holder") && ($(".vcg").removeClass("vih"), $(".vcg").unbind("click").bind("click", function () {
                ...
                F(e.attr("vic"))
            })), j = $("body > .vhw"), j.find(".vaw:not(.vih)").length ? (k = $(window).width(), l = $(window).height(), a.pageX + j.outerWidth() > k ? j.css("left", k - j.outerWidth()) : j.css("left", a.pageX), a.pageY + j.outerHeight() > l ? j.css("top", l - j.outerHeight()) : j.css("top", a.pageY), b(), j.show()) : j.hide(), !1
            ...
            }, 300), c($(this).attr("vgv"))), $(".vem").removeClass("empty-vem"), b()
            ...
            return b == $.localStorage(xb + ".vhh") && ($(".vet").addClass("vih"), $.localStorage(xb + ".vhh", ""), $.localStorage(xb + ".vhg", "")), $("#vhl [viy=" + b + "]").remove(), $.localStorage(xb + ".vhk", $("#vhl").html()), setTimeout(function () {
                $(".vfw").find(".ves").length ? $(".vfw").removeClass("empty-vfw") : $(".vfw").addClass("empty-vfw")
            }, 50), a = $.localStorage.io(xb + ".state.veu." + b), a.remove(), a = $.localStorage.io(xb + ".state.vem." + b), a.remove(), $(this).parent().remove(), !1
        ...
        }), $(document).on("click", ".vkt", function () {
            var a = $(this).parent().attr("optionalClass"),
                b = $(this).parent().attr("classtarget");
            $(this).hasClass("vku") ? $(b).removeClass(a) : $(b).addClass(a), $(this).toggleClass("vku"), $(b).each(function () {
                "" == $(this).attr("class") && $(this).removeAttr("class")
            }), V()
...
function muteAllYouTube() {
    $(".youtube-bg-iframe").each(function () {
        var a = new YT.Player($(this).attr("id"), {
            events: {
                onReady: function () {
                    a.mute(), a.playVideo()
                }
